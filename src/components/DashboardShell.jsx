...
export default function DashboardShell({ session, subscription }) {
  ...
  useEffect(() => {
    ...
    const JSX_TABS = ['social-pub','locallinks','voice','schema-mon','pages','local','rank-tracker','meta','gbpqa','napaudit','kwgap']
  ...
  return (
    <div style={{ display:'flex', height:'100vh', background:bg,
      ...
      <div style={{ flex:1,display:'flex',flexDirection:'column',overflow:'hidden',minWidth:0,margin:0,padding:0 }}>
        ...
        {/* Tool iframe */}
        {activeTab!=='clients' && activeTab!=='social-pub' && activeTab!=='locallinks' && activeTab!=='voice' && activeTab!=='schema-mon' && activeTab!=='pages' && activeTab!=='local' && activeTab!=='rank-tracker' && activeTab!=='meta' && activeTab!=='gbpqa' && activeTab!=='napaudit' && activeTab!=='kwgap' && (
