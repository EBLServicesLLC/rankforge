...
export default function DashboardShell({ session, subscription }) {
  ...
  const JSX_TABS_SW = ['dash','bl','keys','social-proof','social-pub','locallinks','voice','schema-mon','pages','local','rank-tracker','meta','gbpqa','napaudit','kwgap','reputation','web2','pdfreport'];
  ...
  useEffect(() => {
    ...
    const JSX_TABS = ['dash','bl','keys','social-proof','social-pub','locallinks','voice','schema-mon','pages','local','rank-tracker','meta','gbpqa','napaudit','kwgap','reputation','web2','pdfreport']
  ...
  return (
    <div style={{ display:'flex', height:'100vh', background:bg,
      ...
      <div style={{ flex:1,display:'flex',flexDirection:'column',overflow:'hidden',minWidth:0,margin:0,padding:0 }}>
        ...
        {/* Tool iframe */}
        {activeTab!=='clients' && activeTab!=='dash' && activeTab!=='bl' && activeTab!=='keys' && activeTab!=='social-proof' && activeTab!=='social-pub' && activeTab!=='locallinks' && activeTab!=='voice' && activeTab!=='schema-mon' && activeTab!=='pages' && activeTab!=='local' && activeTab!=='rank-tracker' && activeTab!=='meta' && activeTab!=='gbpqa' && activeTab!=='napaudit' && activeTab!=='kwgap' && activeTab!=='reputation' && activeTab!=='web2' && activeTab!=='pdfreport' && (
