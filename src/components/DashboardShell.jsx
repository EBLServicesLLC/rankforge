...
export default function DashboardShell({ session, subscription }) {
  ...
  const JSX_TABS_SW = ['dash','bl','social-proof','social-pub','locallinks','voice','schema-mon','pages','local','rank-tracker','meta','gbpqa','napaudit','kwgap','reputation','web2','pdfreport'];
  ...
  useEffect(() => {
    ...
    const JSX_TABS = ['dash','bl','social-proof','social-pub','locallinks','voice','schema-mon','pages','local','rank-tracker','meta','gbpqa','napaudit','kwgap','reputation','web2','pdfreport']
