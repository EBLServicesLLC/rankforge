...
import SocialPublisherPage from './SocialPublisherPage'
import LocalLinksPage from './LocalLinksPage'
import VoiceSearchPage from './VoiceSearchPage'
import SchemaMonitorPage from './SchemaMonitorPage'
import LandingPageBuilder from './LandingPageBuilder'
import LocalSEOPage from './LocalSEOPage'
import RankTrackerPage from './RankTrackerPage'
import MetaTagGeneratorPage from './MetaTagGeneratorPage'
import GbpQaPage from './GbpQaPage'
import NapAuditPage from './NapAuditPage'
import KwGapPage from './KwGapPage'
import ReputationPage from './ReputationPage'
import Web2Page from './Web2Page'
...
export default function DashboardShell({ session, subscription }) {
  ...
  const JSX_TABS_SW = ['dash','bl','keys','index','social-proof','social-pub','locallinks','voice','schema-mon','pages','local','rank-tracker','meta','gbpqa','napaudit','kwgap','reputation','web2','pdfreport','agents','calendar','gsc'];
  ...
  useEffect(() => {
    ...
    const JSX_TABS = ['dash','bl','keys','index','social-proof','social-pub','locallinks','voice','schema-mon','pages','local','rank-tracker','meta','gbpqa','napaudit','kwgap','reputation','web2','pdfreport','agents','calendar','gsc']
      ...
      <div style={{ flex:1,display:'flex',flexDirection:'column',overflow:'hidden',minWidth:0,margin:0,padding:0 }}>
        ...
        {activeTab === 'dash' && (
          <div style={{ flex:1, overflowY:'auto', background:'#060d1a' }}>
            <DashboardPage clientId={activeId} userId={session.user.id} />
          </div>
        )}

        {/* Backlinks — renders inline */}
        {activeTab === 'bl' && (
          <div style={{ flex:1, overflowY:'auto', background:'#060d1a' }}>
            <BacklinksPage session={session} clientId={activeId} />
          </div>
        )}
        ...
        {/* Local Links — renders inline, no iframe needed */}
        {activeTab === 'locallinks' && (
          <div style={{ flex:1, overflowY:'auto', background:'#060d1a' }}>
            <LocalLinksPage session={session} />
          </div>
        )}

        {/* Voice & FAQ — renders inline */}
        {activeTab === 'voice' && (
          <div style={{ flex:1, overflowY:'auto', background:'#060d1a' }}>
            <VoiceSearchPage session={session} clientId={activeId} />
          </div>
        )}

        {/* Schema Monitor — renders inline */}
        {activeTab === 'schema-mon' && (
          <div style={{ flex:1, overflowY:'auto', background:'#060d1a' }}>
            <SchemaMonitorPage session={session} clientId={activeId} />
          </div>
        )}
        ...
        {/* Local SEO — renders inline */}
        {activeTab === 'local' && (
          <div style={{ flex:1, overflowY:'auto', background:'#060d1a' }}>
            <LocalSEOPage session={session} clientId={activeId} />
          </div>
        )}
        ...
        {/* Meta Tag Generator — renders inline */}
        {activeTab === 'meta' && (
          <div style={{ flex:1, overflowY:'auto', background:'#060d1a' }}>
            <MetaTagGeneratorPage session={session} clientId={activeId} />
          </div>
        )}

        {/* GBP Q&A Manager — renders inline */}
        {activeTab === 'gbpqa' && (
          <div style={{ flex:1, overflowY:'auto', background:'#060d1a' }}>
            <GbpQaPage session={session} clientId={activeId} />
          </div>
        )}
        ...
        {activeTab === 'napaudit' && (
          <div style={{ flex:1, overflowY:'auto', background:'#060d1a' }}>
            <NapAuditPage session={session} clientId={activeId} />
          </div>
        )}
        ...
        {activeTab === 'reputation' && (
          <div style={{ flex:1, overflowY:'auto', background:'#060d1a' }}>
            <ReputationPage session={session} clientId={activeId} />
          </div>
        )}

        {/* Reports — renders inline */}
        {activeTab === 'pdfreport' && (
          <div style={{ flex:1, overflowY:'auto', background:'#060d1a' }}>
            <ReportsPage session={session} clientId={activeId} />
          </div>
        )}

        {/* API Keys — renders inline */}
        {activeTab === 'keys' && (
          <div style={{ flex:1, overflowY:'auto', background:'#060d1a' }}>
        ...
        {/* Indexing & AI Visibility — renders inline */}
        {activeTab === 'index' && (
          <div style={{ flex:1, overflowY:'auto', background:'#060d1a' }}>
            <IndexingPage session={session} clientId={activeId} />
          </div>
        )}

        {/* Social Proof — renders inline */}
        {activeTab === 'social-proof' && (
          <div style={{ flex:1, overflowY:'auto', background:'#060d1a' }}>
            <SocialProofPage session={session} clientId={activeId} />
          </div>
        )}

        {activeTab === 'agents' && (
          <div style={{ flex:1, overflowY:'auto', background:'#060d1a' }}>
            <AgentsPage clientId={activeId} userId={session.user.id} />
          </div>
        )}
